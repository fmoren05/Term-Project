...
@details
This file contains classes and functions for managing an MLX90640 thermal infrared camera, including pixel calibration, temperature compensation, and data reading.
